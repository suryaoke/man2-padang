                            ...
                            <tbody>
                                <?php foreach ($smterkirim as $value) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $suratmasuk['tanggal_surat']; ?></td>
                                        <td> <?php echo $suratmasuk['no_surat']; ?> </td>
                                        <td><?php echo $suratmasuk['perihal']; ?> </td>
                            
                                        <td>
                                            <?php $user = User::find()->where(['id' => $suratmasuk["tujuan"]])->one();
                                            echo $user['nama'];  ?>
                                        </td>
                                      <td>
                                        <?php $user1 = User::find()->where(['id' => $value["id_pengirim"]])->one();
                                         echo $user1['nama'];  ?>
                                        </td>
                                        <td align="center">
                                            <?php
                                        ...
                                        <td align="right">
                                            ...
                                            <?= Html::a('<span class="fa fa-eye"></span>', ['terkirimdisposisi', 'id_sm' => $value->id_sm], ['class' => 'btn btn-info', 'title' => 'Disposisi', 'style'=> 'font-size: 10px;']) ?>
