                ...
                <div class="card ">
                    ...
                    <div class="card-body ">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <!-- // Pembuat Surat // -->
                                <?php foreach ($pembuat as $data) : ?>

                                    <?php $value = Informasisurat::find()->where(['id' => $data->id_informasi])->one(); ?>
                                    <tr>
                                        ...
                                        <td align="right">
                                            ...
                                            <?php if ($value["status"] != "dikirim" ||  Yii::$app->user->identity->role == "admin") { ?>
                                                <?= Html::a('<span class="fa fa-trash"></span>', ['delete', 'id' => $data->id_informasi], [
