            ...
            <div class="col-12">
                <div class="card ">
                    <div class="card-header ">
                        ...
                        &emsp;
                        <span class="">
                            <?= Html::a('Tambah', ['create'], ['class' => 'btn btn-success btn-sm waves-effect waves-light']) ?>
                        </span>
                    </div>
                    <div class="card-body ">
                                ...
                                <?php foreach ($jabatan as $value) : ?>
                                    <tr >
                                        ...
                                        <td align="right">
                                            ...
                                            <?= Html::a('<span class="fa fa-edit"></span>', ['update', 'id_jabatan' => $value->id_jabatan], ['class' => 'btn btn-info', 'title' => 'Edit', 'style'=> 'font-size: 10px;']) ?>
